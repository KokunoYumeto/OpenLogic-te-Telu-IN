...
if (existing.some(isBatchRow) && !refresh) throw new Error('Batch 034 segment rows already exist; pass --refresh to rebuild their mechanical hashes and spans');
...
const common = ['TE-P003', 'TE-P005', 'TE-P008', 'TE-P010', 'TE-P011', 'TE-P018', 'TE-P024', 'TE-P025', 'TE-P027', 'TE-P028', 'TE-P029', 'TE-P032', 'TE-P033', 'TE-P034'];
  ...
  sourceBlocks.forEach((sourceBlock, index) => {
    ...
    rows.push({
      ...
      consultation_phase: structural
        ...
        : `Contemporaneous Batch 034 choice ${segmentId}; exact source and Telugu target were read in full and checked against the listed native passages and TE-T034, TE-T047, TE-T058, TE-T061, TE-T066, TE-T067, TE-T070, TE-T072 and TE-T073 as applicable.`,
      evidence_limit: structural
        ...
        : 'The cited Andhra Pradesh, pre-bifurcation and Telangana-hosted native passages support Telugu number, set, relation, function, formula, first-order, derivation, inference, consistency and proof register. They do not directly attest c.e.-complete theories, omega-consistency, universal computable relations, computable inseparability or interpretation between theories. The frozen definitions, reductions and proofs plus TE-T073 control those specialized senses. OLTETCP-001--003 are source-audit decisions, not language-canon claims.',
    });
  });
}
