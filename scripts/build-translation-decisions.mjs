...
const artifactRefs = {
  terms: publicArtifact('TERM_DECISIONS.jsonl', 'partial-270-of-722'),
...
const full = [
  ...
  '',
  `Edition: **${edition.language_tag} / ${edition.script} / ${edition.register_or_variant}**. Coverage: **270 of 722 source units drafted**. This readable view contains all ${decisions.length} decisions and ${occurrenceCount} recorded occurrences.`,
  '',
...
Status: **partial — 270 of 722 source units drafted**. The canonical register currently contains **${decisions.length} decisions** (${termDecisions.length} terminology/sense decisions and ${correctionDecisions.length} source-correction decisions) with **${occurrenceCount} concrete occurrences**.
