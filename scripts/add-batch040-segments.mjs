...
if (existing.some(isBatchRow) && !refresh) throw new Error('Batch 040 segment rows already exist; pass --refresh to rebuild their mechanical hashes and spans');
  ...
  sourceBlocks.forEach((sourceBlock, index) => {
    ...
    rows.push({
      ...
      consultation_phase: structural
        ...
        : 'Contemporaneous Batch 040 choice ' + segmentId + '; exact source and Telugu target were read in full and checked against the listed native passages and TE-T011, TE-T064, TE-T065, TE-T066, TE-T067, TE-T074, TE-T078 and TE-T079 as applicable.',
      evidence_limit: structural
        ...
        : 'The cited Andhra Pradesh, distinct school-mathematics, and pre-bifurcation Telangana-hosted native passages support Telugu natural-number, set, ordered-pair, relation, function, argument, composition, primitive-recursion, minimization, term, variable, derivation and proof register. They do not directly attest Church numerals, lambda-definability, iterators, fixed-point combinators or the lambda encodings of recursion and minimization. The frozen definitions, reductions and corrected constructions plus TE-T011, TE-T064--TE-T067, TE-T074, TE-T078 and TE-T079 control those specialized senses. OLTELAMCOMP-001--OLTELAMCOMP-008 are source-audit decisions, not language-canon claims.',
    });
  });
}
