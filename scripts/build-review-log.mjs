...
const completion='partial_270_of_722_draft_units';
...
const phase='Evidence reconstruction through 2026-09-19 from the current primary TERM_DECISIONS, aligned segment ledger, canonical-passage records and exact source/target bytes; earlier records are not represented as contemporaneous pre-draft notes, while TE-T064--TE-T069 record the Batch 025--Batch 030 consultations performed during reconciliation.';
...
const priorityMd=['# Priority optional expert-review view','',`Scope: **partial — 270 of 722 draft units**. This view selects ${priorityRecords.length} of ${records.length} open decisions whose nomenclature is highly provisional or whose correction disclosure merits a human clarity check. It creates no translation hold.`,'','Final printed/PDF pages remain pending coherent-reader pagination; exact unit, section, file and line locators are supplied.',''];
