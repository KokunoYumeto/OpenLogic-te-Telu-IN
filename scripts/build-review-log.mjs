...
const correctionRecords=corrections.map(c=>{
 ...
 const unresolvedProof=['OLTELAMALP-005','OLTELAMALP-006','OLTELAMCRPB-003','OLTELAMCRB-001','OLTELAMCRB-003'].includes(c.finding_id);
