...
if (existing.some(isBatchRow) && !refresh) throw new Error('Batch 037 segment rows already exist; pass --refresh to rebuild their mechanical hashes and spans');
  ...
  sourceBlocks.forEach((sourceBlock, index) => {
    ...
    rows.push({
      ...
      consultation_phase: structural
        ...
        : 'Contemporaneous Batch 037 choice ' + segmentId + '; exact source and Telugu target were read in full and checked against the listed native passages and TE-T041, TE-T047, TE-T051, TE-T058, TE-T066, TE-T070, TE-T075 and TE-T076 as applicable.',
      evidence_limit: structural
        ...
        : 'The cited Andhra Pradesh, distinct school-mathematics, and pre-bifurcation Telangana-hosted native passages support Telugu arithmetic, number, set, relation, function, truth-value, formula, sentence, first-order, domain, derivation, inference, induction and proof register. They do not directly attest second-order Peano arithmetic, categoricity, finite satisfiability, non-axiomatizability, compactness failure or the upward and downward Lowenheim--Skolem failures. The frozen axioms, reductions, countermodels and proofs plus TE-T041, TE-T051, TE-T070, TE-T075 and TE-T076 control those specialized senses. OLTESOLMET-001--004 are source-audit decisions, not language-canon claims.',
    });
  });
}
