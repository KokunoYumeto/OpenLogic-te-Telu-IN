...
\olsection{ప్రవచన \usetoken{P}{formula}}

ప్రవచన తర్కంలోని !!^{formula}sను \emph{!!{propositional
    variable}s}\iftag{prvFalse}{\iftag{prvTrue}{,}{ మరియు} ప్రవచన
  స్థిరాంకం~$\lfalse$}{}\iftag{prvTrue}{\iftag{prvFalse}{
    మరియు}{} ప్రవచన స్థిరాంకం~$\ltrue$}{} నుంచి \emph{తార్కిక
  సంయోజకాలను} ఉపయోగించి నిర్మిస్తాం.

\begin{enumerate}
\item !!{propositional variable}s $\Obj p_0$, $\Obj p_1$, \dots గల
  !!^a{denumerable} సమితి~$\PVar$
\tagitem{prvFalse}{!!{falsity} కోసం ప్రవచన స్థిరాంకం~$\lfalse$.}{}
\tagitem{prvTrue}{!!{truth} కోసం ప్రవచన స్థిరాంకం~$\ltrue$.}{}
...
ప్రవచన తర్కంలోని ఈ భాషను $\Lang L_0$తో సూచిస్తాం.
...
ప్రవచన తర్కంలోని \emph{!!{formula}s} సమితి~$\Frm[L_0]$ను కింది
విధంగా ఆగమనాత్మకంగా నిర్వచిస్తాం:
\begin{enumerate}
\tagitem{prvFalse}{$\lfalse$ ఒక పరమాణు !!{formula}.}{}

\tagitem{prvTrue}{$\ltrue$ ఒక పరమాణు !!{formula}.}{}

\item ప్రతి !!{propositional variable}~$\Obj p_i$ ఒక పరమాణు
  !!{formula}.

\tagitem{prvNot}{$!A$ ఒక !!a{formula} అయితే, $\lnot !A$ ఒక
  !!a{formula}.}{}

\tagitem{prvAnd}{$!A$, $!B$లు !!{formula}s అయితే, $(!A \land
  !B)$ ఒక !!a{formula}.}{}

\tagitem{prvOr}{$!A$, $!B$లు !!{formula}s అయితే, $(!A \lor !B)$
  ఒక !!a{formula}.}{}

\tagitem{prvIf}{$!A$, $!B$లు !!{formula}s అయితే, $(!A \lif !B)$
  ఒక !!a{formula}.}{}

\tagitem{prvIff}{$!A$, $!B$లు !!{formula}s అయితే, $(!A \liff !B)$
  ఒక !!a{formula}.}{}

\tagitem{limitClause}{మరేదీ !!a{formula} కాదు.}{}
\end{enumerate}
\end{defn}

\begin{explain}
!!{formula}s నిర్వచనం ఒక \emph{ఆగమనాత్మక నిర్వచనం}. సారాంశంగా,
!!{formula}s సమితిని అనంత దశల్లో నిర్మిస్తాం. మొదటి దశలో అన్ని
పరమాణు సూత్రాలూ సూత్రాలని ప్రకటిస్తాం; ఇది నిర్వచనంలోని మొదటి కొన్ని
సందర్భాలకు, అంటే
\iftag{prvTrue}{$\ltrue$, }{}%
\iftag{prvFalse}{$\lfalse$, }{}%
$\Obj p_i$ సందర్భాలకు సరిపోతుంది. కాబట్టి “పరమాణు !!{formula}”
అంటే ఈ రూపాల్లో ఏదో ఒక రూపంలో ఉన్న !!{formula}.

నిర్వచనంలోని మిగతా సందర్భాలు, అప్పటికే నిర్మించిన !!{formula}s
నుంచి కొత్త !!{formula}sను నిర్మించే నియమాలను ఇస్తాయి. రెండవ దశలో
వాటిని ఉపయోగించి పరమాణు !!{formula}s నుంచి !!{formula}sను
నిర్మించవచ్చు. మూడవ దశలో పరమాణు సూత్రాలు, రెండవ దశలో పొందిన
సూత్రాల నుంచి కొత్త సూత్రాలను నిర్మిస్తాం; ఇలాగే కొనసాగిస్తాం.
అటువంటి ఏదో ఒక దశలో చివరికి నిర్మితమయ్యేదే !!{formula}; మరేదీ
సూత్రం కాదు.
\end{explain}
...
\tagitem{defTrue}{$\ltrue$ అనేది
  \iftag{prvFalse}{$\lnot\lfalse$}{ఏదో స్థిర పరమాణు
    !!{formula}~$!A$కు $(!A \lor \lnot !A)$}కు సంక్షిప్త రూపం.}{}

\tagitem{defFalse}{$\lfalse$ అనేది
  \iftag{prvTrue}{$\lnot\ltrue$}{ఏదో స్థిర పరమాణు
    !!{formula}~$!A$కు $(!A \land \lnot !A)$}కు సంక్షిప్త రూపం.}{}
