...
\begin{thm}[\emph{!!{formula}sపై ఆగమన సూత్రం}]
  \ollabel{thm:induction}
  ఏదైనా ధర్మం~$P$ అన్ని పరమాణు !!{formula}sకు ఉండి, అది కింది
  విధంగా ఉందనుకుందాం:
  \begin{enumerate}
    ...
    \tagitem{prvIff}{$!A$, $!B$లకు అది ఉన్నప్పుడల్లా
      $(!A \liff !B)$కు ఉంటుంది;}{}
  \end{enumerate}
  అప్పుడు $P$ అన్ని !!{formula}sకు ఉంటుంది.
\end{thm}

\begin{proof}
  $P$ ధర్మం గల అన్ని !!{formula}s సంగ్రహాన్ని $S$ అనుకుందాం.
  స్పష్టంగా $S \subseteq \Frm[L_0]$. $S$,
  \olref[fml]{defn:formulas}లోని అన్ని షరతులను సంతృప్తిపరుస్తుంది:
  అది అన్ని పరమాణు !!{formula}sను కలిగి ఉండి, !!{operator}s కింద
...
\begin{prop}\ollabel{prop:balanced}
   $\Frm[L_0]$లోని ఏ !!{formula} అయినా \emph{సమతుల్యం}; అంటే దానిలో
...
!!a{formula} యొక్క ఏ నిజ ఆద్య ఖండమూ !!a{formula} కాదు.
\end{prop}
...
$ \Frm[L_0]$లోని ఏ !!{formula}~$!A$కైనా కింది రూపాల్లో కచ్చితంగా
...
\tagitem{prvNot}{ఏదో !!{formula}~$!B$కు $\lnot !B$.}{}

\tagitem{prvAnd}{ఏవో !!{formula}s $!B$, $!C$లకు
$(!B \land !C)$.}{}

\tagitem{prvOr}{ఏవో !!{formula}s $!B$, $!C$లకు
$(!B \lor !C)$.}{}

\tagitem{prvIf}{ఏవో !!{formula}s $!B$, $!C$లకు
$(!B \lif !C)$.}{}

\tagitem{prvIff}{ఏవో !!{formula}s $!B$, $!C$లకు
$(!B \liff !C)$.}{}
\end{enumerate}
