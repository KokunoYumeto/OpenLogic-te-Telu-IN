...
\emph{\tetoken{సత్యమూల్య కేటాయింపు}{!!{valuation}}} అంటే భాషలోని \tetoken{ప్రతిజ్ఞావాక్య చరాలకు}{!!{propositional variable}s}
$\True$ లేదా $\False$ను కేటాయించే ప్రమేయం~$\pAssign{v}$; అంటే
$\pAssign{v} \colon \PVar \to \{\True, \False \}$.
\end{defn}

\begin{defn}
  ఒక \tetoken{సత్యమూల్య కేటాయింపు}{!!a{valuation}}~$\pAssign{v}$ ఇచ్చినప్పుడు, మూల్యాంకన ప్రమేయం
...
\tetoken{సత్యమూల్య కేటాయింపులు}{!!{valuation}s}, $!A$లో సంభవించే \tetoken{ప్రతిజ్ఞావాక్య చరాలపై}{!!{propositional
variable}s}
ఏకీభవిస్తాయని అనుకుందాం; అంటే, ఆ నిర్దిష్ట
\tetoken{సూత్రం}{!!{formula}}~$!A$లో $\Obj p_n$ సంభవించినప్పుడల్లా
...
\begin{defn}[సంతృప్తి]
\ollabel{defn:satisfaction} \emph{ఒక \tetoken{సూత్రం}{!!a{formula}}~$!A$ను
  \tetoken{ఒక సత్యమూల్య కేటాయింపు}{!!a{valuation}}~$\pAssign{v}$ సంతృప్తిపరచడం} అనే భావన
...
\tagitem{prvIff}{%
  \indcase{!A}{(!B \liff !C)}{$\pSat{v}{\indfrm}$ కావడం,
    ...
    అప్పుడు మాత్రమే.}}{}
\end{enumerate}
$\Gamma$ ఒక \tetoken{సూత్రాలు}{!!{formula}s} సమితి అయితే, $\pSat{v}{\Gamma}$ కావడం,
