...
\]
ఈ క్రమిత జతలను ఒక \emph{పట్టిక}లో ఇలా అమర్చవచ్చు:
\[
...
\end{array}
\]
$\Nat \times \Nat$లోని ప్రతి క్రమిత జత పట్టికలో కచ్చితంగా ఒక్కసారి
...
\begin{prop}
ప్రతి $n \in \Nat$కు $\Nat^n$ !!{enumerable}.
\end{prop}

\begin{prob}\label{sfr:siz:zigzag:prob:posint-n}
ప్రతి $n \in \Nat$కు $(\PosInt)^n$ !!{enumerable} అని చూపండి.
\end{prob}

\begin{prob}\label{sfr:siz:zigzag:prob:posint-star}
  $(\PosInt)^*$ !!{enumerable} అని చూపండి. మీరు
