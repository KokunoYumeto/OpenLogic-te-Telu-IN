...
సమితుల మధ్య !!a{bijection}కు బదులు, మొదటి సమితి నుంచి రెండవదానికి
!!a{injection} అవసరం. అటువంటి ప్రమేయం ఉంటే, మొదటి సమితి పరిమాణం
రెండవ సమితి పరిమాణానికి తక్కువ లేదా సమానం. సహజంగా చూస్తే, ఒక సమితి
నుంచి మరొకదానికి !!a{injection} ఉండటం వల్ల ఆ ప్రమేయపు పరిధిలో దాని
ప్రవేశంలో ఉన్నన్ని !!{element}s కనీసం ఉంటాయని హామీ వస్తుంది; ఎందుకంటే
ప్రవేశంలోని ఏ రెండు !!{element}s కూడా పరిధిలోని ఒకే !!{element}కు
పంపబడవు.
\end{explain}

\begin{defn}
!!a{injection} $f \colon A \to B$ ఉంటేనే $A$, $B$ను
...
\begin{defn}
!!a{injection}~$f\colon A \to B$ ఉండి, !!{bijection}~$g\colon A
...
వదిలాం.) ఈ సంకేతంతో, $A$ !!{enumerable} కావడానికి అవసరమైన మరియు
సరిపడే షరతు $\cardle{A}{\Nat}$ అవడమనీ, $A$ !!{nonenumerable}
...
!!a{injection}. ఎందుకంటే $x \neq y$ అయితే మూలకాధారిత సమానత్వం వల్ల
...
\oliflabeldef{sfr:siz:nen:sec}{%
  ఇప్పుడు !!a{surjective} ప్రమేయం~$g\colon A \to \Pow{A}$ ఉండజాలదని,
  ఇక !!a{bijective} ప్రమేయం సంగతి చెప్పనక్కరలేదని చూపి,
  ...
  !!{bijection} $g \colon A \to \Pow{A}$ ఉంది. ఇప్పుడు దీన్ని
  పరిశీలించండి:
  \[
    D = \Setabs{x \in A}{x \notin g(x)}
  \]
  $D \subseteq A$ కనుక $D \in \Pow{A}$. $g$ !!a{bijection} కనుక,
...
\oliflabeldef{sfr:siz:nen:thm:nonenum-pownat}{
  ...
  $\overline{Z}$లలో ఒకదానికి !!a{element} అయి, మరొకదానికి కాని సంఖ్య
  ఎప్పుడూ ఉంటుంది. ఇక్కడ కూడా అదే ఆలోచనను అనుసరిస్తాం; అయితే సూచీలు
  $n$ ఇప్పుడు $\PosInt$కు బదులు $A$ యొక్క !!{element}s. ప్రతి
  ...
  ఒకదానికి !!a{element} అయి, మరొకదానికి కాని $A$ యొక్క
  !!a{element} ఎప్పుడూ ఉంటుంది. అందువల్ల $\overline{Z}$, $Z_1$,
...
\oliflabeldef{sfr:siz:nen-alt:thm:nonenum-pownat}{
  ...
  అయితే సూచీలు $n$ ఇప్పుడు $\Nat$కు బదులు $A$ యొక్క !!{element}s.
...
\begin{prob}
  ఏ సమితి~$A$కైనా !!a{injection} $g\colon \Pow{A} \to A$ ఉండజాలదని
  చూపండి. సూచన: $g\colon \Pow{A} \to A$ !!{injective} అనుకుందాం.
  $D = \Setabs{g(B)}{B \subseteq A \text{ and } g(B) \notin B}$ను
  పరిశీలించండి. $x = g(D)$గా తీసుకోండి. $g$ !!{injective} అనే
