...
\begin{enumerate}
	...
	\\i.e., $s$ is \tetoken{ఒక ఒకటి-ఒకటి ప్రమేయం}{!!a{injection}}
...
\end{enumerate}
మొదటి రెండు షరతులను మొదటిస్థాయి విధేయ తర్కంతో సులభంగా నిర్వహించవచ్చు (పైన
చూడండి). కానీ \olref{repeatedapplication}ను కేవలం మొదటిస్థాయి విధేయ తర్కంతో
...
\begin{enumerate}
	...
	సమితిలోని ఏ \tetoken{మూలకానికైనా}{!!{element}} $s$ను వర్తింపజేస్తే సమితిలోని మరో
	\tetoken{మూలకం}{!!{element}} లభిస్తుంది.
\end{enumerate}
...
కాబట్టి $\closureofunder{f}{o}$ అనేది $o$ను \tetoken{ఒక మూలకంగా}{!!a{element}} కలిగిన
$f$-సంవృత సమితులన్నిటి ఛేదనం. అంతర్బుద్ధి ప్రకారం,
$\closureofunder{f}{o}$ అనేది $o$ను \tetoken{ఒక మూలకంగా}{!!a{element}} కలిగిన
...
\begin{proof}
$o$ను \tetoken{ఒక మూలకంగా}{!!a{element}} కలిగిన కనీసం ఒక $f$-సంవృత సమితి ఉంది; అదే
...
$o$ను \tetoken{ఒక మూలకంగా}{!!a{element}} కలిగిన సమితుల ఛేదనం కనుక
...
ఏదో $o \in A$తో కూడిన, కింది షరతులను సంతృప్తిపరిచే $A$ అనే సమితి:
	\begin{enumerate}
		...
		\item \ollabel{ded:injection} $f$ is \tetoken{ఒక ఒకటి-ఒకటి ప్రమేయం}{!!a{injection}}
		\item \ollabel{ded:closure} $A = \closureofunder{f}{o}$
	\end{enumerate}
\end{defn}

$A = \closureofunder{f}{o}$ కనుక, $o$ను \tetoken{ఒక మూలకంగా}{!!a{element}} కలిగిన
