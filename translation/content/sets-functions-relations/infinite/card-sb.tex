...
అంటే, !!{injection}s $f \colon A \to B$, $g \colon B \to A$
ఇచ్చినప్పుడు !!a{bijection} $h \colon A \to B$ ఉంటుంది.
...
\begin{proof}
!!a{bijection} $f \colon C \to A$ ఇచ్చినప్పుడు,
...
\[
	...
	\begin{cases}
		...
		\end{cases}
\]
$g$, $C \to B$ నుంచి !!a{bijection} అని చూపుతాం; దాని నుంచి
$\comp{f^{-1}}{g} \colon A \to B$ ఒక !!a{bijection} అని వస్తుంది;
...
$f(x) = g (x) = g(y) = f(y)$; $f$ !!a{bijection} కనుక $x = y$.
...
$f \colon A \to B$, $g \colon B \to A$లు !!{injection}s అనుకుందాం.
...
!!{injection}; నిజానికి దాని సహప్రవేశాన్ని నిర్వచించిన విధానం వల్లనే
$\comp{f}{g}$ ఒక !!a{bijection}. అందువల్ల
$\cardeq{\funimage{g}{\funimage{f}{A}}}{A}$; కాబట్టి
\olref{sbhelper} ప్రకారం !!a{bijection}
$h \colon A \to \funimage{g}{B}$ ఉంది. అంతేకాక $g^{-1}$ అనేది
$\funimage{g}{B} \to B$ నుంచి !!a{bijection}. కాబట్టి
$\comp{h}{g^{-1}} \colon A \to B$ ఒక !!a{bijection}.
\end{proof}
