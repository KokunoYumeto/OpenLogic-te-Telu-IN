...
\begin{explain}
\oliflabeldef{sfr:fun:inv:sec}{\tetoken{ఒక ద్విగుణ ప్రమేయం}{!!a{bijection}} $f$ యొక్క విలోమం $f^{-1}$
...
\tetoken{మూలకాన్ని}{!!{element}}, $C$లోని \tetoken{ఒక మూలకానికి}{!!a{element}} జతచేస్తుంది.
$A$లోని \tetoken{ఒక మూలకం}{!!a{element}}, $C$లోని ఏ \tetoken{మూలకానికి}{!!{element}} జతచేయబడుతుందో
...
\begin{prob}
$f \colon A \to B$, $g \colon B \to C$ రెండూ \tetoken{ఒకటి-ఒకటి}{!!{injective}} అయితే,
$\comp{f}{g}\colon A \to C$ కూడా \tetoken{ఒకటి-ఒకటి}{!!{injective}} అని చూపండి.
\end{prob}

\begin{prob}
$f \colon A \to B$, $g \colon B \to C$ రెండూ \tetoken{సంగ్రస్త}{!!{surjective}} అయితే,
$\comp{f}{g}\colon A \to C$ కూడా \tetoken{సంగ్రస్త}{!!{surjective}} అని చూపండి.
\end{prob}
