...
$B$లో గానీ \tetoken{మూలకాలుగా}{!!{element}s} ఉన్న వస్తువులన్నీ ఉంటాయి.
అంటే ఇది $A$, $B$ల \tetoken{మూలకాలను}{!!{element}s} కలిపే సమితి.
దీనిని \olref{fig:union}లో చూడవచ్చు. అందులో గుర్తించిన ప్రాంతం
రెండు సమితులు $A$, $B$లకు చెందిన \tetoken{మూలకాలను}{!!{element}s}
కలిపి చూపిస్తుంది.

\begin{figure}
  \olasset{assets/diagrams/union.tikz}
  \caption{రెండు సమితుల సమ్మేళనం $A \cup B$ అనేది $A$లోని
  \tetoken{మూలకాలను}{!!{element}s}, $B$లోని మూలకాలతో కలిపిన సమితి.}
  \ollabel{fig:union}
\end{figure}
...
ఇది $A$లోనో, $B$లోనో, లేదా రెండింటిలోనో \tetoken{మూలకాలుగా}{!!{element}s} ఉన్న
...
\begin{ex}
\tetoken{మూలకాలను}{!!{element}s} ఎన్నిసార్లు పేర్కొన్నామన్నది ముఖ్యం కాదు.
అందువల్ల రెండు సమితులకు ఉమ్మడిగా \tetoken{ఒక మూలకం}{!!a{element}} ఉన్నప్పుడు,
వాటి సమ్మేళనంలో ఆ \tetoken{మూలకం}{!!{element}} ఒక్కసారి మాత్రమే ఉంటుంది.
...
$A$లో \tetoken{మూలకాలుగా}{!!{element}s} ఉంటూ, $B$లో కూడా \tetoken{మూలకాలుగా}{!!{element}s} ఉండే
\tetoken{మూలకాల}{!!{element}s} సమితిని ఏర్పరచే ప్రక్రియ ఇది.
...
\begin{figure}
  ...
  \caption{రెండు సమితుల ఛేదనం $A \cap B$ అనేది వాటికి ఉమ్మడిగా
    ఉన్న \tetoken{మూలకాల}{!!{element}s} సమితి.}
...
ఇది $A$, $B$ రెండింటిలోనూ \tetoken{మూలకాలుగా}{!!{element}s} ఉన్న వస్తువులన్నింటి సమితి.
\[
A \cap B = \Setabs{x}{x \in A \land x \in B}
\]
రెండు సమితుల ఛేదనం శూన్యమైతే వాటిని \emph{వియుక్త} సమితులు అంటాం.
అంటే వాటికి ఉమ్మడి \tetoken{మూలకాలు}{!!{element}s} ఏవీ ఉండవు.
\end{defn}

\begin{ex}
రెండు సమితులకు ఉమ్మడి \tetoken{మూలకాలు}{!!{element}s} ఏవీ లేకపోతే, వాటి ఛేదనం శూన్యం:
$\{ a, b, c\} \cap \{ 0, 1\} = \emptyset$.

రెండు సమితులకు ఉమ్మడి \tetoken{మూలకాలు}{!!{element}s} ఉంటే, వాటన్నింటి సమితే ఛేదనం:
$\{a, b, c \} \cap \{a, b, d \} = \{a, b\}$.
...
\tetoken{మూలకానికి}{!!{element}} చెందిన వస్తువులన్నింటి సమితిగా నిర్వచించవచ్చు.
ఛేదనాన్ని, ఈ సమితిలోని ప్రతి \tetoken{మూలకానికి}{!!{element}} చెందిన వస్తువులన్నింటి
సమితిగా నిర్వచించవచ్చు.
\end{explain}

\begin{defn}
$A$ అనేది సమితుల సమితి అయితే, $\bigcup A$ అనేది $A$లోని
\tetoken{మూలకాల}{!!{element}s} \tetoken{మూలకాల}{!!{element}s} సమితి:
\begin{align*}
\bigcup A & = \Setabs{x}{x \text{ అనేది } A\text{లోని \tetoken{ఒక మూలకానికి}{!!a{element}} చెందుతుంది}},
\text{ అంటే,}\\
...
\begin{align*}
\bigcap A & = \Setabs{x}{x \text{ అనేది } A\text{లోని ప్రతి \tetoken{మూలకానికి}{!!{element}} చెందుతుంది}},
\text{ అంటే,}\\
...
చివరగా, $A$లో ఉంటూ $B$లో లేని \tetoken{మూలకాల}{!!{element}s}
సమితిని పరిశీలిద్దాం. దీనిని \olref{difference}లో చూపించవచ్చు.

\begin{figure}
  \olasset{assets/diagrams/difference.tikz}
  \caption{రెండు సమితుల భేదం $A \setminus B$ అనేది $A$లో
    \tetoken{మూలకాలుగా}{!!{element}s} ఉండి, $B$లో \tetoken{మూలకాలుగా}{!!{element}s} లేని వస్తువుల సమితి.}
  \ollabel{difference}
\end{figure}

\begin{defn}[భేదం]
\emph{సమితుల భేదం} $A \setminus B$ అనేది $A$లో
\tetoken{మూలకాలుగా}{!!{element}s} ఉండి, $B$లో \tetoken{మూలకాలుగా}{!!{element}s} లేని వస్తువులన్నింటి సమితి.
అంటే,
\[
