...
\begin{explain}
సమితులలోని మూలకాలకు క్రమం ఉండదని మూలకాధారిత సమానత్వం చెబుతుంది.
కనుక క్రమాన్ని సూచించాలంటే $\tuple{x, y}$ అనే \emph{క్రమిత జతలను}
వాడతాం. $\{x, y\}$ అనే అక్రమిత జతలో క్రమం ముఖ్యం కాదు:
$\{x, y\} = \{y, x\}$. క్రమిత జతలో మాత్రం క్రమం ముఖ్యం:
$x \neq y$ అయితే $\tuple{x, y} \neq \tuple{y, x}$.

సమితి సిద్ధాంతంలో క్రమిత జతలను ఎలా పరిగణించాలి? రెండు క్రమిత జతలలో
...
\]
సమితి సిద్ధాంతంలో వీనర్--కురటోవ్‌స్కీ నిర్వచనాన్ని వాడి క్రమిత జతలను
నిర్వచించవచ్చు.
\end{explain}

\begin{defn}[క్రమిత జత]\ollabel{wienerkuratowski}
	$\tuple{a, b} = \{\{a\}, \{a, b\}\}$.
\end{defn}
...
\begin{explain}
క్రమిత జత నిర్వచనాన్ని నిర్ణయించాక, దానితో మరిన్ని సమితులను
...
మొదటి మూలకమే ఒక క్రమిత జతగా ఉన్న ప్రత్యేక క్రమిత జతగా త్రికాన్ని
...
క్రమిత జతలతో లేదా ఇతర క్రమిత $n$-బహుళకాలతో ఏర్పడే కొన్ని సమితులు
మనకు ఉపయోగపడతాయి.
\end{explain}
...
\begin{prob}
$\{1, 2, 3\}^3$లోని \tecase{acc}{!!{element}s} అన్నింటినీ జాబితాగా రాయండి.
\end{prob}

\begin{prop}\ollabel{cardnmprod}
$A$లో $n$ !!{element}s, $B$లో $m$ !!{element}s ఉంటే,
$A \times B$లో $n\cdot m$ మూలకాలు ఉంటాయి.
\end{prop}

\begin{proof}
$A$లోని ప్రతి !!{element} $x$కూ, $\tuple{x, y} \in A \times B$
రూపంలో $m$ !!{element}s ఉంటాయి. $B_x = \Setabs{\tuple{x, y}}{y
  \in B}$ అనుకుందాం. $x_1 \neq x_2$ అయినప్పుడల్లా
$\tuple{x_1, y} \neq \tuple{x_2, y}$ కనుక
$B_{x_1} \cap B_{x_2} = \emptyset$.
అయితే $A = \{x_1, \dots, x_n\}$ అయితే,
$A \times B = B_{x_1} \cup \dots \cup B_{x_n}$.
కాబట్టి అందులో $n\cdot m$ !!{element}s ఉంటాయి.

దీనిని చూడటానికి $A \times B$లోని \tecase{acc}{!!{element}s}
...
$A$లో $n$ !!{element}s ఉంటే, $A^k$లో $n^k$ !!{element}s ఉంటాయి.
\end{prob}

\begin{ex}
$A$ ఒక సమితి అయితే, $A$పై ఒక \emph{పదం} అంటే $A$లోని
\tecase{gen}{!!{element}s} ఏదైనా క్రమం. అటువంటి క్రమాన్ని $A$లోని
\tecase{gen}{!!{element}s} $n$-బహుళకంగా పరిగణించవచ్చు.
...
ఒక ఆనవాయితీ ప్రకారం $A$లోని \tecase{acc}{!!{element}s}
