...
యొక్క $\Log{LK}$-\tetoken{వ్యుత్పత్తిని}{!!{derivation}} $\pi_0$ అందాం. ఒక
$\RightR{\lforall}$ నిగమనాన్ని చేరిస్తే
$\Gamma_0 \Sequent \lforall[x][!A(x)]$ యొక్క \tetoken{ఒక వ్యుత్పత్తి}{!!a{derivation}} వస్తుంది.
...
\tagitem{prvEx}{$!A(t) \Sequent \lexists[x][!A(x)]$ సీక్వెంట్
  \tetoken{వ్యుత్పాదించదగిన}{!!{derivable}}:
  \begin{prooftree}
