...
వీటి నుంచి సీక్వెంట్ కలనంలోని !!^{derivation}s ఆగమనాత్మకంగా
ఉత్పన్నమవుతాయి: ప్రతి !!{derivation} తనంతట తానే ఒక ప్రారంభ సీక్వెంట్
అయినా అవుతుంది, లేదా ఒకటి లేదా రెండు !!{derivation}s తర్వాత ఒక
నిగమనం ఉండే రూపంలో ఉంటుంది.
\end{explain}

\begin{defn}[$\Log{LK}$ !!{derivation}]
ఒక సీక్వెంట్~$S$కు \emph{$\Log{LK}$-!!{derivation}} అంటే కింది
...
\end{enumerate}
అప్పుడు $S$ను ఆ !!{derivation} యొక్క \emph{అంత్య సీక్వెంట్} అనీ,
$S$ను \emph{$\Log{LK}$లో !!{derivable}} (లేదా
$\Log{LK}$-!!{derivable}) అనీ అంటాం.
\end{defn}

\begin{ex}
ప్రతి ప్రారంభ సీక్వెంట్, ఉదాహరణకు $!C \Sequent !C$, ఒక
!!a{derivation}. దీనికి, ఉదాహరణకు, $\LeftR{\Weakening}$ నియమాన్ని
వర్తింపజేసి కొత్త !!{derivation}ను పొందవచ్చు:
\begin{prooftree}
...
!!{sentence}నైనా, ఉదాహరణకు $!D$ను కూడా పెట్టవచ్చు. పూర్వాధారం మన
ప్రారంభ సీక్వెంట్ $!C \Sequent !C$తో సరిపోలితే, $\Gamma$, $\Delta$
రెండూ కేవలం $!C$ అని అర్థం; అప్పుడు నిష్కర్ష $!D, !C \Sequent !C$
అవుతుంది. కాబట్టి కిందిది ఒక !!a{derivation}:
\begin{prooftree}
\Axiom$ !C \fCenter !C $
\RightLabel{\LeftR{\Weakening}}
\UnaryInf$ !D, !C \fCenter !C$
\end{prooftree}
ఇప్పుడు ఎడమవైపు ఉన్న రెండు !!{sentence}s స్థానాలను మార్చనిచ్చే మరొక
నియమాన్ని, ఉదాహరణకు $\LeftR{\Exchange}$ను, వర్తింపజేయవచ్చు. అందువల్ల
కిందిది కూడా సరైన !!{derivation}:
\begin{prooftree}
\Axiom$ !C \fCenter !C $
\RightLabel{\LeftR{\Weakening}}
\UnaryInf$ !D, !C \fCenter !C$
...
విధంగా కిందిది కూడా ఒక !!a{derivation} అని చూస్తాం:
\begin{prooftree}
\Axiom$ !D \fCenter !D $
\RightLabel{\LeftR{\Weakening}}
\UnaryInf$ !C, !D \fCenter !D$
\end{prooftree}
ఇప్పుడు ఈ రెండు !!{derivation}sను తీసుకొని $\RightR{\land}$తో
కలపవచ్చు. ఆ నియమం:
\begin{prooftree}
...
\end{prooftree}
మన సందర్భంలో పూర్వాధారాలు, వాటితో ముగిసే !!{derivation}sలోని చివరి
