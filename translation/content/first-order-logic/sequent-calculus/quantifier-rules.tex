...
ఇక్కడ కూడా $t$ ఒక సంవృత పదం; $a$ ఒక !!a{constant}, అది
...
\begin{explain}
!!a{formula} అయిన $!A$లో !!{variable}~$x$ స్వేచ్ఛగా ఉంటే దానిని
$!A(x)$ అని రాస్తామనే
...
అంతకంటే ఎక్కువను బద్ధ !!{variable}~$x$తో “మార్చవచ్చు”; అన్నిటినీ
మార్చాల్సిన అవసరం లేదు. అయితే \RightR{\lforall},
\LeftR{\lexists}లలోని ఐగెన్ చరరాశి షరతులు !!{constant}~$a$ అనేది
...
!!{constant}~$a$ ఎక్కడా కనిపించరాదు. వ్యవస్థ నిర్దుష్టంగా ఉండేలా,
అంటే చెల్లుబాటు అయ్యే సీక్వెంట్లను మాత్రమే !!{derive}s చేసేలా చేయడానికి
