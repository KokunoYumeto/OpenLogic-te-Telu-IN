...
\Sequent \quad$లను !!{derive}s చేస్తుంది. $\Gamma_0 \Sequent !A$
యొక్క $\Log{LK}$-!!{derivation}ను $\pi_0$ అనీ, $\Gamma_1, !A
\Sequent \quad$ యొక్క $\Log{LK}$-!!{derivation}ను $\pi_1$ అనీ
అందాం. అప్పుడు కిందివిధంగా !!{derive} చేయవచ్చు:
\begin{prooftree}
\AxiomC{}
\RightLabel{$\pi_0$}
...
యొక్క ఒక !!a{derivation}~$\pi_0$ ఉంది. ఒక $\LeftR{\lnot}$ నియమాన్ని
చేర్చితే $\lnot !A, \Gamma \Sequent \quad$ యొక్క ఒక
!!a{derivation} వస్తుంది; అంటే $\Gamma \cup \{\lnot !A\}$
వైరుధ్యభరితం.

$\Gamma \cup \{\lnot !A\}$ వైరుధ్యభరితమైతే,
$\lnot !A, \Gamma \Sequent \quad$ యొక్క ఒక !!a{derivation}~$\pi_1$
ఉంటుంది. కిందిది $\Gamma \Sequent !A$ యొక్క ఒక !!a{derivation}:
\begin{prooftree}
  \Axiom$!A \fCenter !A$
...
\begin{proof}
  ...
  !!a{derivation}~$\pi$ ఉంటుంది. $\lnot !A, \Gamma_0 \Sequent \quad$
  సీక్వెంట్ కూడా !!{derivable}:
  \begin{prooftree}
    \AxiomC{}
    \RightLabel{$\pi$}
    \Deduce$\Gamma_0 \fCenter !A$
...
$\lnot !A, \Gamma_1 \Sequent \quad$ల యొక్క $\Log{LK}$-!!{derivation}s
$\pi_0$, $\pi_1$ ఉన్నాయి. అప్పుడు కిందివిధంగా !!{derive} చేయవచ్చు:
\begin{prooftree}
\AxiomC{}
\RightLabel{$\pi_0$}
