...
\emph{నిరూపణ-సిద్ధాంత భావనలను} నిర్వచిస్తాం. వీటిని !!{structure}sలో
!!{sentence}s సంతృప్తి చెందడాన్ని ఆశ్రయించి నిర్వచించం; కొన్ని
సీక్వెంట్ల !!{derivability} లేదా !!{nonderivability}ను ఆశ్రయించి
...
!!^a{sentence}~$!A$కు $\quad \Sequent !A$ సీక్వెంట్ యొక్క ఒక
$\Log{LK}$ !!a{derivation} ఉంటే, దానిని \emph{సిద్ధాంతం} అంటాం.
$!A$ సిద్ధాంతమైతే $\Proves !A$ అనీ, కాకపోతే $\Proves/ !A$ అనీ రాస్తాం.
\end{defn}

\begin{defn}[!!^{derivability}]
!!{sentence}s సమితి~$\Gamma$ నుంచి !!^a{sentence}~$!A$
\emph{!!{derivable}}, అంటే $\Gamma \Proves !A$, అవుతుంది అంటే:
$\Gamma_0 \subseteq \Gamma$ అనే ఒక పరిమిత ఉపసమితి, $\Gamma_0$లోని
!!{sentence}sతో కూడిన $\Gamma_0'$ అనే ఒక క్రమం ఉండి, $\Log{LK}$
$\Gamma_0' \Sequent !A$ను !!{derive}s చేయాలి. $\Gamma$ నుంచి $!A$
!!{derivable} కాకపోతే $\Gamma \Proves/ !A$ అని రాస్తాం.
\end{defn}

సంకోచనం, బలహీనీకరణ, మార్పిడి నియమాల వల్ల $\Gamma_0'$లోని
!!{sentence}s క్రమమూ, వాటి సంఖ్యా ముఖ్యం కాదు: $\Gamma_0' \Sequent !A$
సీక్వెంట్ !!{derivable} అయితే, $\Gamma_0'$లో ఉన్న !!{sentence}sనే
కలిగిన ఏ $\Gamma_0''$కైనా $\Gamma_0'' \Sequent !A$ కూడా
నిగమించదగినది. ఉదాహరణకు $\Gamma_0 = \{!B, !C\}$ అయితే,
$\Gamma_0' = \tuple{!B, !B, !C}$, $\Gamma_0'' =
\tuple{!C, !C, !B}$ రెండూ $\Gamma_0$లోని !!{sentence}sనే కలిగిన
క్రమాలు. వీటిలో ఒకదాన్ని కలిగిన సీక్వెంట్ !!{derivable} అయితే
...
\end{prooftree}
ఇకపై $\Gamma_0$ ఒక పరిమిత !!{sentence}s సమితి అయితే,
$\Gamma_0 \Sequent !A$ అనేది $\Gamma_0$లోని !!{sentence}s క్రమాన్ని
...
\begin{proof}
ప్రారంభ సీక్వెంట్ $!A \Sequent !A$ అనేది !!{derivable}; అంతేకాక
$\{!A\} \subseteq \Gamma$.
\end{proof}
...
ఒక పరిమిత సమితికి $\Gamma_0 \Sequent !A$ !!{derivable} అవుతుంది.
$\Gamma \subseteq \Delta$ కనుక $\Gamma_0$ అనేది $\Delta$కు కూడా
పరిమిత ఉపసమితి. కాబట్టి $\Gamma_0 \Sequent !A$ యొక్క !!{derivation}
...
సమితి, $\Gamma_0 \Sequent !A$ యొక్క !!a{derivation}~$\pi_0$ ఉంటాయి.
$\{!A\} \cup \Delta \Proves !B$ అయితే ఏదో పరిమిత ఉపసమితి
$\Delta_0 \subseteq \Delta$కు $!A, \Delta_0 \Sequent !B$ యొక్క
!!a{derivation}~$\pi_1$ ఉంటుంది. కింది !!{derivation}ను పరిశీలించండి:
\begin{prooftree}
  \AxiomC{}
  \RightLabel{$\pi_0$}
