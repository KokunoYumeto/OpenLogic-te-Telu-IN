...
$\Gamma$ ఒక !!{sentence}s సమితి అనుకుందాం. $\Gamma$ అవైరుధ్యమైతే,
...
!!{complete} సమితి ఉంది.
\iftag{FOL}{
  $\Gamma' \subseteq \Gamma^*$ కనుక, ప్రతి !!{formula}~$!A(x)$కు
  $\Gamma^*$లో
  \iftag{prvEx}
        {$\lexists[x][!A(x)] \lif !A(c)$}
        {$\lnot\lforall[x][!A(x)] \lif \lnot !A(c)$}
  రూపంలోని !!a{sentence} ఉంటుంది; అందువల్ల $\Gamma^*$
...
కాబట్టి $\Gamma$ సంతృప్తిపరచదగినది.\iftag{FOL}{
  ...
  !!{sentence}s~$!A$కు $\Sat{\equivclass{M}{\approx}}{!A}$ అయినప్పుడు,
  అప్పుడు మాత్రమే $!A \in \Gamma^*$. ప్రత్యేకంగా, ప్రతి $!A \in
...
అన్ని~$\Gamma$, !!{sentence}s~$!A$లకు: $\Gamma \Entails !A$ అయితే
$\Gamma \Proves !A$.
\end{cor}
...
!!{sentence}s సమితి~$\Delta$కైనా, $\Delta$ అవైరుధ్యమైతే అది
...
\tagprob{FOL}
\begin{prob}
ఒక !!a{derivation} వ్యవస్థ సంపూర్ణంగా ఉండాలంటే, ప్రతి
సంతృప్తిపరచలేని సమితీ వైరుధ్యభరితమని నిరూపించగలిగేంత బలమైన నియమాలు
దానికి ఉండాలి. సంపూర్ణతను నిరూపించడానికి !!{derivation} నియమాల్లో ఏవి
...
ఏ !!{derivation} నియమాలు ఉపయోగించబడ్డాయో చూపే జాబితా లేదా రేఖాచిత్రం
