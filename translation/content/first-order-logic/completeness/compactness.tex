...
\tetoken{వాక్యాలు}{!!{sentence}s} సమితిలోని ప్రతి
...
సంఖ్య వల్లనే ఉత్పన్నమయ్యే వైరుధ్యభరిత అనంత \tetoken{వాక్యాలు}{!!{sentence}s} సమితులు
...
\tetoken{వాక్యాలు}{!!{sentence}s} సమితులు లేవు. సంపూర్ణతా సిద్ధాంతంలాగే, దీనికి అనుగమనానికి
సంబంధించిన ఒక రూపం ఉంది: ఒక అనంత \tetoken{వాక్యాలు}{!!{sentence}s} సమితి ఏదైనా విషయాన్ని
అనుగమింపజేస్తే, ఇప్పటికే దాని ఒక పరిమిత ఉపసమితి దాన్ని అనుగమింపజేస్తుంది.

\begin{defn}
  \tetoken{సూత్రాలు}{!!{formula}s} సమితి~$\Gamma$లోని ప్రతి పరిమిత $\Gamma_0 \subseteq
...
సహజంగానే~$\Domain{M}$లోని \tetoken{ఒక మూలకాన్ని}{!!a{element}} సూచిస్తుంది. $\Domain{M}$లోని
ప్రతి \tetoken{మూలకాన్ని}{!!{element}} కూడా ఏదో ఒక పదం సూచిస్తుందని హామీ ఇవ్వగలమా?
...
$c$ అనేది~$\Gamma$ భాషలో లేని \tetoken{ఒక స్థిరసంకేతం}{!!a{constant}} అనుకుందాం. $t$ అనేది
...
$a \in \Domain{M}$ అనే ఒక $\Domain{M}$లోని \tetoken{ఒక మూలకాన్ని}{!!a{element}} తీసుకొని,
$\Struct{M}$లాగే
ఉండి అదనంగా $\Assign{c}{M'} = a$ అయ్యే \tetoken{నిర్మాణాన్ని}{!!{structure}}~$\Struct{M'}$
...
\begin{ex}
\tetoken{విధేయ సంకేతం}{!!{predicate}}~$<$, \tetoken{స్థిరసంకేతాలు}{!!{constant}s}~$\Obj{0}$, $\Obj{1}$, ఇంకా
\tetoken{ప్రమేయ సంకేతాలు}{!!{function}s}~$+$, $\times$, $-$లను కలిగిన \tetoken{ఒక భాష}{!!a{language}}~$\Lang{L}$ను
పరిశీలించండి. ప్రదేశం~$\Rat$, స్పష్టమైన అర్థవివరణలు గల
\tetoken{నిర్మాణం}{!!{structure}}~$\Struct{Q}$లో సత్యమైన ఈ \tetoken{భాషలోని}{!!{language}} అన్ని
\tetoken{వాక్యాలు}{!!{sentence}s} సమితిని~$\Gamma$ అందాం. కరణీయ సంఖ్యల గురించి సత్యమైన
~$\Lang{L}$లోని అన్ని \tetoken{వాక్యాలు}{!!{sentence}s} సమితి~$\Gamma$. సహజంగానే
...
ఉపయోగించవచ్చు. మన భాషలో భాగహారానికి \tetoken{ఒక ప్రమేయ సంకేతం}{!!a{function}} లేదు (సున్నాతో
భాగహారం నిర్వచితం కాదు; \tetoken{ప్రమేయ సంకేతాలను}{!!{function}s} సర్వత్ర నిర్వచిత ప్రమేయాలతోనే
అర్థం చేసుకోవాలి). అయినా $r < 1/k$ అని వ్యక్తం చేయవచ్చు; ఎందుకంటే
$r \cdot k < 1$ అయినప్పుడు, అప్పుడు మాత్రమే అది నిజం. ఇప్పుడు $c$ ఒక
కొత్త \tetoken{స్థిరసంకేతం}{!!{constant}} అనుకొని, $\Delta$ను ఇలా ఉంచండి:
\[
\{\Obj{0} < c\}
...
\tetoken{వాక్యాలు}{!!{sentence}s} $c \times \num{k} < \Obj{1}$కు $k < K$ అయ్యే ఒక~$K$
...
ను సంతృప్తిపరిచే \tetoken{మూలకం}{!!{element}}~$k \in \Domain{N}$ ఏదీ లేదు (ఇక్కడ
$\num{n}$ అనేది $n$~$\prime$లతో $\Obj{0}^{\prime\dots\prime}$).
అంకగణితపు ప్రామాణిక నమూనా~$\Struct{N}$లో సత్యమైన అంకగణిత భాషలోని
\tetoken{వాక్యాలు}{!!{sentence}s}, ప్రతి సూత్రం~$\num{n} < x$ను
\emph{సంతృప్తిపరిచే} \tetoken{ఒక మూలకం}{!!a{element}} ఉన్న \tetoken{ఒక నిర్మాణం}{!!a{structure}}~$\Struct{N'}$లో
...
\iftag{FOL}{
\begin{ex}
\tetoken{తాదాత్మ్య విధేయం}{!!{identity}} గల మొదటిస్థాయి విధేయ తర్కం, \tetoken{వ్యక్తి క్షేత్రం}{!!{domain}} పరిమాణానికి ఏదో ఒక కనిష్ఠ
...
కాబట్టి మొదటిస్థాయి విధేయ తర్కం అనంతత్వాన్ని వ్యక్తం చేయగలదు. అయితే అది
పరిమితత్వాన్ని వ్యక్తం చేయలేదని సంహతత్వ సిద్ధాంతం చూపుతుంది. ఏదో ఒక
వాక్యాల సమితి~$\Lambda$ను అన్ని పరిమిత \tetoken{నిర్మాణాలు}{!!{structure}s}, అవి మాత్రమే,
...
సంతృప్తిపరుస్తాయి కనుక, పరిమిత సంఖ్యలో, కానీ $\ge n$ \tetoken{మూలకాలు}{!!{element}s} గల
నమూనా~$\Struct{M}$ దానికి ఉంది. అప్పుడు $\Sat{M}{\Delta' \cup
\Lambda'}$. సంహతత్వం ప్రకారం $\Delta \cup \Lambda$కు ఒక అనంత నమూనా
ఉంది; ఇది~$\Lambda$ను పరిమిత \tetoken{నిర్మాణాలు}{!!{structure}s} మాత్రమే సంతృప్తిపరుస్తాయనే
పరికల్పనకు విరుద్ధం.
\end{ex}
}{}
