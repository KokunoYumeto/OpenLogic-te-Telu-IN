...
\ollabel{def:complete-set} !!{sentence}s సమితి~$\Gamma$ను
\emph{!!{complete}} అంటాం, అప్పుడు మాత్రమే: ఏ !!{sentence}~$!A$కైనా
$!A \in \Gamma$ లేదా $\lnot !A \in \Gamma$.
\end{defn}

\begin{explain}
!!^{complete} వాక్యాల సమితులు ఏ ప్రశ్ననూ సమాధానం లేకుండా వదలవు. ఏ
!!{sentence}~$!A$కైనా, $!A$ సత్యమా అసత్యమా అనేది~$\Gamma$
``చెబుతుంది.'' !!{complete} సమితుల ప్రాముఖ్యం సంపూర్ణతా సిద్ధాంతపు
నిరూపణకే పరిమితం కాదు. ఉదాహరణకు, !!{complete}గా, స్వీకృతీకరించదగినదిగా
ఉన్న సిద్ధాంతం ఎల్లప్పుడూ నిర్ణయించదగినదే.
\end{explain}

\begin{explain}
సంపూర్ణతా నిరూపణలో !!^{complete} అవైరుధ్య సమితులు ముఖ్యమైనవి; ఎందుకంటే
ప్రతి అవైరుధ్య !!{sentence}s సమితి~$\Gamma$ ఏదో ఒక !!a{complete}
అవైరుధ్య సమితి~$\Gamma^*$లో ఇమిడి ఉంటుందని హామీ ఇవ్వగలం.
!!^a{complete} అవైరుధ్య సమితిలో ప్రతి !!{sentence}~$!A$కు $!A$ లేదా
దాని నిషేధం $\lnot !A$ ఉంటుంది, కానీ రెండూ ఉండవు. ప్రత్యేకంగా ఇది
\iftag{FOL}{పరమాణు !!{sentence}s}{ప్రవచన చరరాశులు}కు వర్తిస్తుంది.
కాబట్టి \iftag{FOL}{!!{constant}sతో తగినట్లు విస్తరించిన భాషలోని}{}
!!a{complete} అవైరుధ్య సమితి నుంచి, ఏ
\iftag{FOL}{పరమాణు !!{sentence}s}{!!{propositional variable}s}
~$\Gamma^*$లో ఉన్నాయో దాని ప్రకారం
\iftag{FOL}{!!{predicate}s అర్థవివరణ}{ప్రవచన చరరాశులకు నిర్దేశించే
సత్యమూల్యం} నిర్వచించబడే \iftag{FOL}{!!a{structure}}{!!a{valuation}}ను
నిర్మించవచ్చు. ఈ \iftag{FOL}{!!{structure}}{!!{valuation}} తరువాత
~$\Gamma^*$లోని అన్ని !!{sentence}sను (అందువల్ల~$\Gamma$లోని
...
\begin{prop}
\ollabel{prop:ccs}
$\Gamma$ !!{complete}, అవైరుధ్యమైనది అనుకుందాం. అప్పుడు:
\begin{enumerate}
...
\begin{proof}
కింద అన్నింటిలోనూ~$\Gamma$ !!{complete}, అవైరుధ్యమైనది అని
అనుకుందాం.
\begin{enumerate}
\item $\Gamma \Proves !A$ అయితే, $!A \in \Gamma$.

$\Gamma \Proves !A$ అని అనుకుందాం. దీనికి విరుద్ధంగా $!A \notin
\Gamma$ అని అనుకుందాం. $\Gamma$ !!{complete} కనుక $\lnot !A \in
...
\Gamma$, $!B \notin \Gamma$ అని అనుకుందాం. $\Gamma$ !!{complete}
...
$\Gamma$ !!{complete} కనుక $\lnot !A \in \Gamma$. కింది ఫలితంలోని
అంశం~(2) ప్రకారం
\iftag{FOL}{%
  \tagrefs{prfSC/{fol:seq:ppr:prop:provability-lif},
    prfND/{fol:ntd:ppr:prop:provability-lif},
