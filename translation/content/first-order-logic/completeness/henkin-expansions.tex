...
పరిమాణీకృత \tetoken{సూత్రాలను}{!!{formula}s} సత్యం చేయాలి. దీనికి హామీ ఇవ్వడానికి లియాన్
హెన్కిన్ ప్రతిపాదించిన ఒక ఉపాయాన్ని ఉపయోగిస్తాం. సారాంశంగా, అనంత
సంఖ్యలో \tetoken{స్థిరసంకేతాలను}{!!{constant}s} చేర్చి భాషను విస్తరించడం, ఒక స్వేచ్ఛా
\tetoken{చరం}{!!{variable}} గల ప్రతి \tetoken{సూత్రం}{!!{formula}}~$!A(x)$కు
\iftag{prvEx}
      {$\lexists[x][!A(x)] \lif !A(c)$}
      {$\lnot\lforall[x][!A(x)] \lif \lnot !A(c)$}
రూపంలోని ఒక సూత్రాన్ని చేర్చడం ఈ ఉపాయం; ఇక్కడ $c$ కొత్త
\tetoken{స్థిరసంకేతాలలో}{!!{constant}s} ఒకటి. $\Gamma$ను సంతృప్తిపరచే \tetoken{నిర్మాణాన్ని}{!!{structure}} మనం
...
$\Lang L$లో~$\Gamma$ అవైరుధ్యమై ఉండి, కొత్త \tetoken{స్థిరసంకేతాలు}{!!{constant}s} యొక్క ఒక
\tetoken{అనంతంగా లెక్కించదగిన}{!!a{denumerable}} సమితి $\Obj d_0$, $\Obj d_1$, \dots ను~$\Lang L$కు
చేర్చి $\Lang L'$ను పొందితే, $\Lang L'$లో కూడా~$\Gamma$
అవైరుధ్యంగానే ఉంటుంది.
\end{prop}

\begin{defn}[సంతృప్తీకృత సమితి]
ఒక స్వేచ్ఛా \tetoken{చరం}{!!{variable}}~$x$ గల ప్రతి \tetoken{సూత్రం}{!!{formula}}~$!A(x) \in
\Frm[L]$కు, కింది షరతును నెరవేర్చే \tetoken{ఒక స్థిరసంకేతం}{!!a{constant}}~$c \in \Lang{L}$
ఉంటే, భాష~$\Lang {L}$లోని \tetoken{సూత్రాలు}{!!{formula}s} సమితి~$\Gamma$ను
...
\tetoken{సూత్రాలు}{!!{formula}s}~$!A_i(x_i)$కు $!A_0(x_0)$, $!A_1(x_1)$, \dots అనే ఒక
లెక్కింపును స్థిరపరచండి. \tetoken{వాక్యాలు}{!!{sentence}s}~$!D_n$ను~$n$పై ఆగమనంతో
నిర్వచిస్తాం.

$!A_0(x_0)$లో సంభవించని, మనం~$\Lang{L}$కు చేర్చిన $\Obj d_i$లలో
మొదటి \tetoken{స్థిరసంకేతాన్ని}{!!{constant}} $c_0$గా తీసుకోండి. $!D_0$, \dots,~$!D_{n-1}$
ఇప్పటికే నిర్వచించబడ్డాయని అనుకొని, $!D_0$, \dots,~$!D_{n-1}$లోనూ,
$!A_n(x_n)$లోనూ సంభవించని కొత్త \tetoken{స్థిరసంకేతాలు}{!!{constant}s}~$\Obj d_i$లో మొదటిదాన్ని
$c_n$గా తీసుకోండి.

ఇప్పుడు $!D_{n}$ను కింది \tetoken{సూత్రంగా}{!!{formula}} తీసుకోండి:
\iftag{prvEx}
...
అనుకుందాం. కొత్త \tetoken{స్థిరసంకేతాలు}{!!{constant}s} యొక్క ఒక \tetoken{అనంతంగా లెక్కించదగిన}{!!a{denumerable}} సమితిని
...
$x_n$ మాత్రమే అయిన~$\Lang{L'}$లోని \tetoken{ఒక సూత్రం}{!!a{formula}}. మనం~$c_n$ను
...
ఇప్పుడు చూపుతాం: \iftag{prvAll}{దానిలో ఒక సార్వత్రికంగా పరిమాణీకృత
  \tetoken{వాక్యం}{!!{sentence}} ఉన్నప్పుడు, అప్పుడు మాత్రమే దాని అన్ని రూపాలు
  ఉంటాయి}{}\iftag{defAll,defEx}{}{
  మరియు }\iftag{prvAll}{దానిలో ఒక అస్తిత్వంగా పరిమాణీకృత
  \tetoken{వాక్యం}{!!{sentence}} ఉన్నప్పుడు, అప్పుడు మాత్రమే దాని రూపాల్లో కనీసం ఒకటి
  ఉంటుంది}{}. సంపూర్ణ, అవైరుధ్య, సంతృప్తీకృత సమితి నుంచి మనం
నిర్మించే \tetoken{నిర్మాణం}{!!{structure}} దానిలోని అన్ని పరిమాణీకృత వాక్యాలను సత్యం
...
\begin{proof}
  ...
  \tagitem{prvEx}{%
    \iftag{probEx}{అభ్యాసం.}{మొదట $\lexists[x][!A(x)] \in \Gamma$
      ...
      \tetoken{స్థిరసంకేతం}{!!{constant}}~$c$కు $(\lexists[x][!A(x)] \lif !A(c)) \in
  ...
  \tagitem{prvAll}{%
    \iftag{probAll}{అభ్యాసం.}{అన్ని సంవృత పదాలు~$t$కు $!A(t) \in
      ...
      సంతృప్తీకరణ వల్ల, ఏదో ఒక \tetoken{స్థిరసంకేతం}{!!{constant}}~$c$కు
      ...
      సమితి వైరుధ్యభరితమని చూపే \tetoken{వ్యుత్పత్తిని}{!!{derivation}} ఇవ్వడం అభ్యాసం:
      \[
      \lnot \lforall[x][!A(x)],
