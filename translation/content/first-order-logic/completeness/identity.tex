...
సమితులు~$\Gamma$కు మొదటిస్థాయి విధేయ తర్కపు సంపూర్ణతను స్థాపించడానికి
...
\tetoken{ఒక వాక్యం}{!!a{sentence}}~$\eq[t][t']$ ఉండవచ్చు; పద నమూనాలో ఏ పదం విలువైనా ఆ
...
\begin{defn}
  $\Gamma^*$ అనేది~$\Lang L$లోని వాక్యాల అవైరుధ్య, \tetoken{సంపూర్ణ}{!!{complete}}
...
\item $t \approx t'$, $f$ ఒక \tetoken{ప్రమేయ సంకేతం}{!!a{function}}, ఇంకా $t_1$, \dots,
...
\]
\item $t \approx t'$, $R$ ఒక \tetoken{విధేయ సంకేతం}{!!a{predicate}}, ఇంకా $t_1$, \dots,
  $t_{i-1}$, $t_{i+1}$, \dots, $t_n$లు సంవృత పదాలైతే,
\begin{multline*}
...
\begin{proof}
$\Gamma^*$ అవైరుధ్యమైనది, \tetoken{సంపూర్ణ}{!!{complete}} కనుక $\eq[t][t'] \in
...
\]
ప్రతి $n$-స్థాన \tetoken{ప్రమేయ సంకేతం}{!!{function}}~$f$కు, సంవృత పదాలు $t_1$, \dots,
...
ఇది ప్రతి $n$-స్థాన \tetoken{విధేయ సంకేతం}{!!{predicate}}~$R$కు, సంవృత పదాలు $t_1$, \dots,
...
\begin{defn}
$\Gamma^*$ అనేది భాష~$\Lang L$లోని అవైరుధ్య, \tetoken{సంపూర్ణ}{!!{complete}} సమితి,
...
$\Struct{\equivclass{M}{\approx}}$ కింది \tetoken{నిర్మాణం}{!!{structure}}:
\begin{enumerate}
...
అదే ఫలితాన్ని ఇవ్వాలి. ఉదాహరణకు, $R$ ఒక ఏకస్థాన \tetoken{విధేయ సంకేతం}{!!{predicate}} అయితే,
...
\begin{digress}
$\Struct{M(\Gamma^*)}$ ఎల్లప్పుడూ \tetoken{లెక్కించదగిన}{!!{enumerable}}, అనంతమైనదే అయినా,
...
\tetoken{నిర్మాణం}{!!{structure}} అయినా పరిమితంగా ఉండాలని కోరే \tetoken{వాక్యాలు}{!!{sentence}s} ఉండవచ్చు.
ఉదాహరణకు, $\lforall[x][\lforall[y][x = y]]$ ఒక అవైరుధ్య
\tetoken{వాక్యం}{!!{sentence}}; కానీ సరిగ్గా ఒక \tetoken{మూలకం}{!!{element}} మాత్రమే గల \tetoken{ఒక వ్యక్తి క్షేత్రం}{!!a{domain}} ఉన్న
\tetoken{నిర్మాణాలలోనే}{!!{structure}s} అది సంతృప్తిపరచబడుతుంది.
\end{digress}
