...
!!{tableau}x ఉనికిని ఆశ్రయించి నిర్వచిస్తాం. ఈ భావనలు ఒకటే అవుతాయని
...
$\sFmla{\False}{!A}$ కోసం ఒక సంవృత !!{tableau} ఉంటే
!!{sentence}~$!A$ను \emph{సిద్ధాంతం} అంటాం. $!A$ ఒక సిద్ధాంతమైతే
...
కింది సమితికి ఒక సంవృత !!{tableau} ఉండాలి:
\[
\{
  \sFmla{\False}{!A},
  \sFmla{\True}{!B_1}, \dots,
  ...
  \}.
\]
$\Gamma$ నుంచి $!A$ !!{derivable} కాకపోతే $\Gamma \Proves/ !A$
అని రాస్తాం.
\end{defn}

\begin{defn}[అవైరుధ్యం]
!!{sentence}s సమితి~$\Gamma$ \emph{వైరుధ్యభరితమైనది} అంటే,
$\{!B_1, \dots, !B_n\} \subseteq \Gamma$ అనే పరిమిత సమితి ఒకటి,
కింది సమితికి ఒక సంవృత !!{tableau} ఉండాలి:
\[
\{
...
ఉపసమితి; కింది !!{tableau} సంవృతమైనది:
\begin{oltableau}
...
\dots, \sFmla{\True}{!C_n}\}
\intertext{కు ఒక సంవృత !!{tableau} ఉంటుంది. $\Gamma \Proves !A$
  అయితే, $\{!D_1, \dots, !D_m\} \subseteq \Gamma$ అయ్యేలా}
\{\sFmla{\False}{!A}, & \sFmla{\True}{!D_1},
\dots, \sFmla{\True}{!D_m}\}
\end{align*}
కు ఒక సంవృత !!{tableau} ఉంటుంది.
...
ఇప్పుడు కింది పరికల్పనలు గల !!{tableau}ను పరిశీలించండి:
\[
\sFmla{\False}{!B},
...
\sFmla{\True}{!C_1}, \dots, \sFmla{\True}{!C_n}\}
\]
ఈ పరికల్పనలకు సంవృత !!{tableau} ఉంది కనుక దాన్ని ఆ శాఖకు
...
\sFmla{\True}{!D_m}\}
\]
కనుక మరొక వైపునూ పూర్తిచేసి ఒక సంవృత !!{tableau}ను పొందవచ్చు. ఇది
...
\begin{proof}
  \begin{enumerate}
    \item $\Gamma \Proves !A$ అయితే, పరిమిత ఉపసమితి
      ...
      \]
      ఇదే !!{tableau}, $\Gamma_0 \Proves !A$ అని కూడా చూపుతుంది.
    \item $\Gamma$ వైరుధ్యభరితమైతే, ఏదో పరిమిత ఉపసమితి
      $\Gamma_0 = \{!B_1, \dots, !B_n\}$ కోసం కింది సమితికి ఒక
      సంవృత !!{tableau} ఉంటుంది:
      \[
      \{\sFmla{\True}{!B_1}, \dots, \sFmla{\True}{!B_n}\}
      \]
      ఈ సంవృత !!{tableau}, $\Gamma_0$ వైరుధ్యభరితమని చూపుతుంది.
  \end{enumerate}
\end{proof}
