...
!!{identity}తో !!^{tableau}sకు అదనపు నిగమన నియమాలు అవసరం.
...
!!{formula}s కనిపించాలి: $\sFmla{\True}{\eq[t_1][t_2]}$,
$\sFmla{S}{!A(t_1)}$ రెండూ.
...
!!^{tableau}s, $\eq$ సమమితమైనదని కూడా నిరూపిస్తాయి; అంటే
...
!!{formula}~$\sFmla{\True}{\eq[s_1][s_2]}$. వరుస~$3$,
...
\end{oltableau}
ఈ !!{tableau}లో $\TRule{\True}{\eq}$కు మొదటి పూర్వాపేక్ష
!!{formula}, వరుస~$3$లోని $\sFmla{\True}{\eq[s_2][s_3]}$
...
!!{formula}~$\eq[s_1][s_3]$గా మారుతుంది.
