...
\begin{explain}
  టాబ్లోల !!{derivability} సంబంధం~$\Proves$, $!A \land !B
...
\begin{proof}
  ...
  \item $\{\sFmla{\False}{!A}, \sFmla{\True}{!A \land !B}\}$,
    ...
    \item $\{\sFmla{\True}{!A}, \sFmla{\True}{!B},
      \sFmla{\False}{!A \land !B}\}$కు సంవృత !!{tableau} ఇది:
      \begin{oltableau}
...
\begin{proof}
  \begin{enumerate}
    \item $\{\sFmla{\False}{!B}, \sFmla{\True}{!A \lif !B},
      \sFmla{\True}{!A}\}$కు సంవృత !!{tableau} ఉంది:
      \begin{oltableau}
        [\sFmla{\False}{\formula{B}}, just=\TAss
