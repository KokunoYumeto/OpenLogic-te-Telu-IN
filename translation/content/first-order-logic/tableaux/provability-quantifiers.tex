...
\in \Gamma$ ఉండి, కింది సమితికి ఒక సంవృత \tetoken{టాబ్లో}{!!{tableau}} ఉంది:
\begin{align*}
\{ \sFmla{\False}{!A(c)}, &
\sFmla{\True}{!B_1}, \dots, \sFmla{\True}{!B_n} \}.
\intertext{కింది సమితికి కూడా ఒక సంవృత \tetoken{టాబ్లో}{!!{tableau}} ఉందని చూపాలి:}
\{ \sFmla{\False}{\lforall[x][!A(x)]}, &
\sFmla{\True}{!B_1}, \dots, \sFmla{\True}{!B_n} \}.
\end{align*}
ఇచ్చిన సంవృత \tetoken{టాబ్లోలో}{!!{tableau}} మొదటి పరికల్పన స్థానంలో
...
\end{tableau}
\end{center}
ముందు పరికల్పనలుగా లభించిన \tetoken{వాక్యాలు}{!!{sentence}s} అన్నీ కొత్త
\tetoken{టాబ్లో}{!!{tableau}} అగ్రభాగంలో ఇంకా లభిస్తున్నాయి కనుక అది సంవృతంగానే ఉంటుంది.
చేర్చిన వరుస $\TRule{\False}{\lforall}$ను సరిగ్గా వర్తింపజేసిన
ఫలితం: \tetoken{స్థిరసంకేతం}{!!{constant}}~$c$ అనేది $!B_1$, \dots, $!B_n$లలో గానీ
$\lforall[x][!A(x)]$లో గానీ కనిపించదు; అంటే కొత్త \tetoken{టాబ్లోలో}{!!{tableau}}
...
\tagitem{prvEx}{$\sFmla{\False}{\lexists[x][!A(x)]},
  \sFmla{\True}{!A(t)}$కు సంవృత \tetoken{టాబ్లో}{!!{tableau}} ఇది:
  \begin{oltableau}
...
\tagitem{prvAll}{$\sFmla{\False}{\formula{A}(t)},
  \sFmla{\True}{\lforall[x][!A(x)]}$కు సంవృత \tetoken{టాబ్లో}{!!{tableau}} ఇది:
  \begin{oltableau}
