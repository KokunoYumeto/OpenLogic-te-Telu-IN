...
\begin{ex}
\tetoken{వాక్యం}{!!{sentence}} $(!A \land !B) \lif !A$ కోసం ఒక సంవృత \tetoken{టాబ్లోను}{!!{tableau}}
కనుగొందాం.

మొదట సంబంధిత పరికల్పనను \tetoken{టాబ్లో}{!!{tableau}} అగ్రభాగంలో రాస్తాం.
\begin{oltableau}
  [\sFmla{\False}{(\formula{A} \land \formula{B}) \lif \formula{A}},
    just = \TAss]
\end{oltableau}

ఒకే పరికల్పన ఉంది; కనుక నియమాన్ని వర్తింపజేయగల \tetoken{చిహ్నిత సూత్రం}{!!{signed formula}}
ఒక్కటే. (ప్రతి \tetoken{చిహ్నిత సూత్రానికి}{!!{signed formula}} వర్తించగల నియమం గరిష్ఠంగా
ఒక్కటే ఉంటుంది: అది సంబంధిత సంకేతానికి, \tetoken{వాక్యం}{!!{sentence}} యొక్క
\tetoken{ప్రధాన సంయోజకానికి}{!!{main operator}} గల నియమం.) ఈ సందర్భంలో మనం
...
\end{oltableau}
ఏ \tetoken{చిహ్నిత సూత్రాలకు}{!!{signed formula}s} వాటి సంబంధిత నియమాలను వర్తింపజేశామో
...
తనిఖీ గుర్తు పెట్టండి. ఒక \tetoken{చిహ్నిత సూత్రానికి}{!!a{signed formula}} సంబంధించిన నియమం
...
ఇప్పుడు నియమాన్ని వర్తింపజేయగల కొత్త \tetoken{చిహ్నిత సూత్రం}{!!{signed formula}} ఒకటి ఉంది:
...
సంవృతమైంది. అదే ఒక్క శాఖ కనుక \tetoken{టాబ్లో}{!!{tableau}} కూడా సంవృతమైంది.
$(!A \land !B) \lif !A$ కోసం ఒక సంవృత \tetoken{టాబ్లోను}{!!{tableau}} కనుగొన్నాం.
\end{ex}

\begin{ex}
ఇప్పుడు $(\lnot !A \lor !B) \lif (!A \lif !B)$ కోసం ఒక సంవృత
\tetoken{టాబ్లోను}{!!{tableau}} కనుగొందాం.
...
\end{oltableau}
ఈ \tetoken{టాబ్లోలోని}{!!{tableau}} ఒక్క \tetoken{చిహ్నిత సూత్రానికి}{!!{signed formula}} \tetoken{ప్రధాన సంయోజకం}{!!{main operator}}~$\lif$,
...
ప్రతి \tetoken{చిహ్నిత సూత్రానికి}{!!{signed formula}} సంబంధించిన నియమాన్ని ప్రతి శాఖలోనూ
వర్తింపజేస్తే చాలు; మనం ఎంచుకునే క్రమం ముఖ్యం కాదు. కాబట్టి మొదటి
ఎంపికను తీసుకుందాం. $\TRule{\True}{\lor}$ నియమం \tetoken{టాబ్లోను}{!!{tableau}}
శాఖలుగా విడగొడుతుంది; నియమపు రెండు నిష్కర్షలు రెండు కొత్త శాఖలకు
చేర్చే కొత్త \tetoken{చిహ్నిత సూత్రాలు}{!!{signed formula}s} అవుతాయి. దాని ఫలితం:
\begin{oltableau}
  [\sFmla{\False}{(\lnot \formula{A} \lor \formula{B}) \lif
...
వర్తింపజేసినప్పుడు మాత్రమే ఒక \tetoken{చిహ్నిత సూత్రం}{!!a{signed formula}} పక్కన తనిఖీ గుర్తు
పెడతామని గుర్తుంచుకోండి. అందువల్ల ఒక నియమం వర్తించే
\tetoken{చిహ్నిత సూత్రాన్ని}{!!{signed formula}} కలిగిన ప్రతి శాఖ చివరలోనూ ఆ నియమాన్ని వర్తింపజేయడం మంచి
పద్ధతి. అప్పుడు వివిధ శాఖల్లో కిందికి వెళ్లిన తర్వాత మళ్లీ ఆ
\tetoken{చిహ్నిత సూత్రం}{!!{signed formula}} దగ్గరకు తిరిగి రావాల్సిన అవసరం ఉండదు.
\begin{oltableau}
  [\sFmla{\False}{(\lnot \formula{A} \lor \formula{B}) \lif
      (\formula{A} \lif \formula{B})}, just=\TAss, checked
    [\sFmla{\True}{\lnot \formula{A} \lor \formula{B}},
...
\begin{ex}
ఎన్ని \tetoken{చిహ్నిత సూత్రాలనైనా}{!!{signed formula}s} పరికల్పనలుగా తీసుకుని \tetoken{టాబ్లోలను}{!!{tableau}s}
ఇవ్వవచ్చు. శాఖలుగా విడగొట్టే ఒకటి కంటే ఎక్కువ నియమాలను
వర్తింపజేయడం కూడా తరచుగా అవసరం; సాధారణంగా ఒక \tetoken{టాబ్లోకు}{!!a{tableau}} ఎన్ని
శాఖలైనా ఉండవచ్చు. ఉదాహరణకు,
$\{\sFmla{\True}{!A \lor (!B \land !C)}, \sFmla{\False}{(!A \lor !B) \land (!A
  \lor !C)}\}$ కోసం ఒక \tetoken{టాబ్లోను}{!!a{tableau}} పరిశీలించండి. మొదటి పరికల్పనకు
...
$\TRule{\True}{\land}$ను వర్తింపజేసి సంవృత \tetoken{టాబ్లోను}{!!{tableau}} పొందుతాం:
\begin{oltableau}
  [\sFmla{\True}{\formula{A} \lor (\formula{B} \land \formula{C})},
    just=\TAss, checked
    [\sFmla{\False}{(\formula{A} \lor \formula{B}) \land
...
సమితికి సంవృత \tetoken{టాబ్లో}{!!{tableau}} ఇది:
\begin{oltableau}
  [\sFmla{\True}{\formula{A} \lor (\formula{B} \land \formula{C})},
    just=\TAss, checked
    [\sFmla{\False}{(\formula{A} \lor \formula{B}) \land
