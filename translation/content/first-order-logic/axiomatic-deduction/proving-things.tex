...
దీన్ని !!{derive} చేయడానికి \MP{} నియమాన్ని ఉపయోగించాలి. మనకున్న
...
$!D \lif !D$కు ఒక !!a{derivation}ను కనుగొనే ప్రయత్నం చేద్దాం.
ఇది ఒక స్వీకృత రూపం కాదు; అందువల్ల దీన్ని !!{derive} చేయడానికి
...
!!{derive} చేయలేం. కాబట్టి మనకు వేరొక వ్యూహం కావాలి.
...
మనం !!{derive} చేయాలని లక్ష్యంగా పెట్టుకున్న !!{formula}~$!D \lif !D$
అయ్యే రూపం కావాలి. అప్పుడు
$!A$, $!C$ రెండూ~$!D$ అవుతాయి. $!A \lif (!B \lif !C)$,
$!A \lif !B$—అంటే మన సందర్భంలో $!D \lif (!B \lif !D)$,
$!D \lif !B$—రెండూ !!{derivable} అయ్యేలా~$!B$ను ఎలా ఎంచుకోవాలి?
...
కొన్నిసార్లు కొన్ని ఇతర !!{formula}s~$\Gamma$ నుంచి ఏదో ఒక
!!{formula}కు ఒక !!a{derivation} ఉందని చూపాలనుకుంటాం. ఉదాహరణకు,
$\Gamma = \{!A \lif !B, !B \lif !C\}$ నుంచి $!A \lif !C$ను
!!{derive} చేయగలమని చూపుదాం.
\begin{derivation}
  1. & $!A \lif !B$ & \Hyp\\
  2. & $!B \lif !C$ & \Hyp\\
...
!!{formula} అనేది~$\Gamma$ యొక్క ఒక !!a{element} అని సూచిస్తాయి.
\end{ex}
...
\begin{proof}
  ...
  !!a{derivation}, అలాగే~$\Gamma$ నుంచి $!B \lif !C$కు ఒక
  !!a{derivation} ఉన్నాయి. వాటిని ఒకదాని తరువాత మరొకటి చేర్చి ఒకే
  !!{derivation}గా చేయండి. ఇప్పుడు ముందరి ఉదాహరణలోని
  !!{derivation}లో 3--7 పంక్తులను చేర్చండి. ఇది~$\Gamma$ నుంచి
  $!A \lif !C$కు ఒక !!a{derivation}; అదే కొత్త !!{derivation}లోని
  చివరి పంక్తి.
  పంక్తులు 4, 7ల సమర్థనల్లో, 1వ పంక్తి సూచనను $!A \lif !B$ యొక్క
  !!{derivation}లోని చివరి పంక్తి సూచనతో, 2వ పంక్తి సూచనను
  $!B \lif !C$ యొక్క !!{derivation}లోని చివరి పంక్తి సూచనతో
  మార్చినా అవి చెల్లుతూనే ఉంటాయని గమనించండి.
\end{proof}

\begin{prob}
స్వీకృతాల నుంచి !!{derivation}sను చూపడం ద్వారా కిందివి చెల్లుతాయని
నిరూపించండి:
\begin{enumerate}
