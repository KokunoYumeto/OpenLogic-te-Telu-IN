...
\begin{ex}
!!{sentence}~$(!A \land !B) \lif !A$ యొక్క ఒక !!a{derivation}ను
ఇద్దాం.

కావలసిన నిష్కర్షను !!{derivation} అడుగున రాయడంతో మొదలుపెడతాం.
\begin{prooftree}
\AxiomC{}
\UnaryInfC{$(!A\land !B) \lif !A$}
\end{prooftree}

ఇలాంటి రూపంలోని ఒక !!a{sentence}ను ఏ రకపు నిగమనం ఇవ్వగలదో ఇప్పుడు
కనుగొనాలి. నిష్కర్షలోని !!{main operator}~$\lif$; కనుక
...
!!{discharged} అయ్యాయో లేదో సులభంగా చూడవచ్చు.
\begin{prooftree}
...
\UnaryInfC{$(!A\land !B) \lif !A$}
\end{prooftree}
ఇప్పుడు $(!A \land !B) \lif !A$కు ఒక సరైన !!{derivation} ఉంది.
\end{ex}
...
$\lif$ను మాత్రమే పట్టించుకుంటాం; అది నిష్కర్షలోని !!{sentence} యొక్క
!!{main operator}. $\lnot$, $\lor$, రెండవ $\lif$ మరొక సంయోజకం
...
కుడివైపున్న రెండు శాఖల్లోనూ $!A \lif !B$ను !!{derive} చేయాలి;
...
!!{derivation}లోని ఖాళీగా ఉన్న రెండు భాగాల కోసం, మధ్యలో $\lnot !A$,
$!A$ల నుంచి, ఎడమవైపు $!A$, $!B$ల నుంచి $!B$ యొక్క
!!{derivation}s కావాలి. మొదట ముందుదాన్ని తీసుకుందాం.
...
ఇప్పుడు కుడివైపు చివరి శాఖను చూద్దాం. !!{derivation} నిర్వచనం
...
!!{derive} చేయడం అల్పసాధ్యం: $!B$ తనంతట తానే అలాంటి
!!a{derivation}; ఏ నిగమనాలూ అవసరం లేదు. కాబట్టి $!A$ పరికల్పనను
తొలగించవచ్చు.
\begin{prooftree}
\AxiomC{$\Discharge{\lnot !A \lor !B}{1}$}
\AxiomC{$\Discharge{\lnot !A}{2}$}
...
\UnaryInfC{$(\lnot !A \lor !B) \lif (!A \lif !B)$}
\end{prooftree}
పూర్తయిన !!{derivation}లో కుడివైపు చివరి \Intro{\lif} నిగమనం
వాస్తవానికి ఏ పరికల్పననూ ఉపసంహరించదని గమనించండి.
\end{ex}

\begin{ex}
ఇప్పటివరకు మనకు \FalseCl{} నియమం అవసరం కాలేదు. నియమపు నిష్కర్షకు
ఉప-!!{formula} కాని ఒక పరికల్పనను ఉపసంహరించనివ్వడం దీని ప్రత్యేకత.
...
!!{derive} చేయాలనుకుందాం. సాధారణ వ్యూహం $\Intro{\lor}$ ఉపయోగించి
$!A \lor \lnot !A$ను !!{derive} చేయడానికి ప్రయత్నించడం. కానీ అలా
చేయాలంటే పరికల్పనలేమీ లేకుండా $!A$ లేదా $\lnot !A$లో ఒకదాన్ని
!!{derive} చేయాలి; అది సాధ్యం కాదు. ఇప్పుడు \FalseCl{} ఆదుకుంటుంది!
\begin{prooftree}
...
!!a{derivation} కోసం చూస్తున్నాం. $\lfalse$ అనేది $\Elim{\lnot}$
...
\begin{prooftree}
  ...
  \UnaryInfC{$!A \lor \lnot !A$}
\end{prooftree}
$\lnot !A$ యొక్క ఒక !!a{derivation}ను కనుగొనే మన వ్యూహం
