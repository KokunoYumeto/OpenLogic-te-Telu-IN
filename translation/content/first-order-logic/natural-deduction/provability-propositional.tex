...
\begin{explain}
  సహజ నిగమనపు \tetoken{వ్యుత్పాద్యత}{!!{derivability}} సంబంధం~$\Proves$, $!A \land !B
...
\begin{proof}
  \begin{enumerate}
  \item రెండింటినీ ఇలా \tetoken{నిగమనం}{!!{derive}} చేయవచ్చు:
    \begin{prooftree}
      \AxiomC{$!A \land !B$}
      ...
      \UnaryInfC{$!B$}
    \end{prooftree}
  \item ఇలా \tetoken{నిగమనం}{!!{derive}} చేయవచ్చు:
    \begin{prooftree}
      \AxiomC{$!A$}
      \AxiomC{$!B$}
...
\begin{proof}
  \begin{enumerate}
  \item కింది \tetoken{వ్యుత్పత్తిని}{!!{derivation}} పరిశీలించండి:
    \begin{prooftree}
      \AxiomC{$!A \lor !B$}
      \AxiomC{$\lnot !A$}
      ...
      \TrinaryInfC{$\lfalse$}
    \end{prooftree}
    ఇది \tetoken{ఉపసంహరించని}{!!{undischarged}} పరికల్పనలు $!A \lor !B$, $\lnot !A$,
    $\lnot !B$ల నుంచి $\lfalse$ యొక్క ఒక \tetoken{వ్యుత్పత్తి}{!!a{derivation}}.
  \item రెండింటినీ ఇలా \tetoken{నిగమనం}{!!{derive}} చేయవచ్చు:
    \begin{prooftree}
      \AxiomC{$!A$}
...
\begin{proof}
  ...
  \item కింది రెండు \tetoken{వ్యుత్పత్తులు}{!!{derivation}s} దీన్ని చూపుతాయి:
    \begin{prooftree}
      \AxiomC{$\lnot !A$}
      \AxiomC{$\Discharge{!A}{1}$}
      \RightLabel{\Elim{\lnot}}
      ...
      \UnaryInfC{$!A \lif !B$}
    \end{prooftree}
    $\Intro{\lif}$ పరికల్పన~$!A$ను \tetoken{ఉపసంహరణ}{!!{discharge}} చేయవచ్చు; కానీ
