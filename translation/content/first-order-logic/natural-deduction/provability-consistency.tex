...
\begin{proof}
$\Gamma$ నుంచి $!A$ యొక్క !!{derivation}ను $\delta_1$ అనీ,
$\Gamma \cup \{!A\}$ నుంచి $\lfalse$ యొక్క !!{derivation}ను
$\delta_2$ అనీ అందాం. అప్పుడు కిందివిధంగా !!{derive} చేయవచ్చు:
\begin{prooftree}
...
\BinaryInfC{$\lfalse$}
\end{prooftree}
కొత్త !!{derivation}లో పరికల్పన~$!A$ !!{discharged} అయింది; కాబట్టి
అది $\Gamma$ నుంచి ఒక !!a{derivation}.
\end{proof}
...
\begin{proof}
మొదట $\Gamma \Proves !A$ అనుకుందాం; అంటే !!{undischarged}
పరికల్పనలు~$\Gamma$ నుంచి $!A$ యొక్క ఒక !!a{derivation}~$\delta_0$
ఉంది. కిందివిధంగా $\Gamma \cup \{\lnot !A\}$ నుంచి $\lfalse$ యొక్క
ఒక !!a{derivation}ను పొందుతాం:
\begin{prooftree}
  \AxiomC{$\lnot !A$}
  \AxiomC{$\Gamma$}
  \RightLabel{$\delta_0$}
...
దానికి అనుగుణంగా $\Gamma \cup \{\lnot !A\}$లోని !!{undischarged}
పరికల్పనల నుంచి $\lfalse$ యొక్క !!{derivation}ను $\delta_1$ అందాం.
$\FalseCl$ను ఉపయోగించి $\Gamma$ ఒక్కదాని నుంచి $!A$ యొక్క ఒక
!!a{derivation}ను ఇలా పొందుతాం:
\begin{prooftree}
...
\begin{proof}
  ...
  $\Gamma$ నుంచి $!A$ యొక్క ఒక !!a{derivation}~$\delta$ ఉంటుంది.
  ...
  \begin{prooftree}
    ...
    \BinaryInfC{$\lfalse$}
  \end{prooftree}
  $\lnot !A \in \Gamma$ కనుక అన్ని !!{undischarged} పరికల్పనలూ
...
నుంచి $\lfalse$ను ఇచ్చే !!{derivation}s~$\delta_1$, $\delta_2$ వరుసగా ఉన్నాయి.
అప్పుడు కిందివిధంగా !!{derive} చేయవచ్చు:
\begin{prooftree}
...
\BinaryInfC{$\lfalse$}
\end{prooftree}
$!A$, $\lnot !A$ పరికల్పనలు !!{discharged} అయ్యాయి కనుక ఇది
$\Gamma$ ఒక్కదాని నుంచి $\lfalse$ యొక్క ఒక !!a{derivation}. అందువల్ల
$\Gamma$ వైరుధ్యభరితమైనది.
\end{proof}
