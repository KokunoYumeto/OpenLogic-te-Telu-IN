...
\tetoken{తాదాత్మ్య విధేయంతో}{!!{identity}} కూడిన \tetoken{వ్యుత్పత్తులకు}{!!^{derivation}s} అదనపు నిగమన నియమాలు అవసరం.
...
ప్రకటననైనా నేరుగా \tetoken{నిగమనం}{!!{derive}} చేయనిస్తుంది.
...
\lif \eq[x][z])]]$ యొక్క \tetoken{వ్యుత్పత్తులు}{!!{derivation}s} ఇవ్వండి.
\end{prob}
...
\intertext{ను ఈ \tetoken{వాక్యం}{!!{sentence}} నుంచి \tetoken{నిగమనం}{!!{derive}} చేస్తాం:}
& \lexists[x][\lforall[y][(!A(y) \lif \eq[y][x])]]
\end{align*}
\tetoken{వ్యుత్పత్తిని}{!!{derivation}} వెనుక నుంచి నిర్మిద్దాం:
\begin{prooftree}
...
\end{prooftree}
ఇప్పుడు ప్రధాన పరికల్పనను వాడాలి: అది ఒక అస్తిత్వ \tetoken{సూత్రం}{!!{formula}} కనుక
మధ్యంతర నిష్కర్ష $\eq[a][b]$ను \tetoken{నిగమనం}{!!{derive}} చేయడానికి
...
\UnaryInfC{$\lforall[x][\lforall[y][((!A(x) \land !A(y)) \lif \eq[x][y])]]$}
\end{prooftree}
కుడివైపు పైనున్న ఉప-\tetoken{వ్యుత్పత్తిని}{!!{derivation}} దాని పరికల్పనలతో
$\eq[a][c]$, $\eq[b][c]$ అని చూపి పూర్తి చేస్తాం. ఇందుకు రెండు వేరు
\tetoken{వ్యుత్పత్తులు}{!!{derivation}s} అవసరం. $\eq[a][c]$కు \tetoken{వ్యుత్పత్తి}{!!{derivation}} కిందివిధంగా ఉంటుంది:
\begin{prooftree}
\AxiomC{$\Discharge{\lforall[y][(!A(y) \lif \eq[y][c]])}{2}$}
...
\tetoken{నిగమనం}{!!{derive}} చేస్తాం.
\end{ex}

\begin{prob}
కింది \tetoken{సూత్రాలు}{!!{formula}s} యొక్క \tetoken{వ్యుత్పత్తులు}{!!{derivation}s} ఇవ్వండి:
\begin{enumerate}
